        ...
        while(1)      
           {    
              ...
              if(mcp_f(0) < md_mcp_f(0)-100 && mcp_f(3) > md_mcp_f(3))
                  ...
                  {
                    Motor(-40, -40, -40, -40); delay(80);  
                    Motor(-2, -2, -2, -2);delay(100);
        ...
        while(1)      
           {
              ...
              if(mcp_f(6) < md_mcp_f(6)-100 || mcp_f(5) < md_mcp_f(5)-100)
                  {
                    Motor(60, 60, 60, 60);delay(50);
                    while(1)
                      {
                        if(mcp_f(4) < md_mcp_f(4) && mcp_f(7) > md_mcp_f(7)) 
                          {
                            do{Motor(2, -30, 2, -30);}while(mcp_f(7) > md_mcp_f(7)+50);    
                            Motor(-2, 30, -2, 30);delay(30);
                          ...
                          {
                            do{Motor(-30, 2, -30, 2);}while(mcp_f(4) > md_mcp_f(4)+50);    
                            Motor(30, -2, 30, -2);delay(30);
                            Motor(0, 0, 0, 0); delay(10);
                            break; 
                          }
