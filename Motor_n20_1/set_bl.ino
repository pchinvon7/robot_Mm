void set_f(int _time)
  {
    ...
    if(mcp_f(1) > md_mcp_f(1) && mcp_f(2) > md_mcp_f(2))
      {
        Motor(-35, -35, -35, -35); delay(120);
        Motor(-2, -2, -2, -2); delay(50);
      }
    else
      {
        Motor(-35, -35, -35, -35); delay(50);
        Motor(-2, -2, -2, -2); delay(50);
      }
    ...
    while(1)
      {
         ...
         if(mcp_f(5) < md_mcp_f(5)||mcp_f(6) < md_mcp_f(6)
           ...
           {
             Motor(50, 50, 50, 50); delay(60);
             Motor(0, 0, 0, 0); delay(200);
             break;
           }

      }   
    Motor(35, 35, 35, 35); delay(60);
    Motor(0, 0, 0, 0); delay(2);   
    last_time = millis();
