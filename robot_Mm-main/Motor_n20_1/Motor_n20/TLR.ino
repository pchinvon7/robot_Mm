        ...
        if(ch_set_fb == true)  // เลือกใช้คำสั่ง set_f(1); set_b(1);
          {
            if(ch_bw == true)  // เลือกใช้คำสั่ง bw( 55, 56, 300, "line");
              {
                Motor(25, 25, 25, 25); delay(line_set_fb);
                Motor(-20, -20, -20, -20); delay(20);
              }
            else              // เลือกใช้คำสั่ง fw( 55, 56, 300, "line");
              {
                Motor(-25, -25, -25, -25); delay(line_set_fb);
                Motor(20, 20, 20, 20); delay(50);
              }
        ...
        else
          {
            if(ch_bw == true)
              {
                Motor(30, 30, 30, 30); delay(line_none_set_fb);
                Motor(-30, -30, -30, -30); delay(50);
              }
            else
              {
                Motor(-30, -30, -30, -30); delay(line_none_set_fb);
